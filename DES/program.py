...
mode = input("Enter the mode 1 for ECB and 2 for CBC")

dec = input("Press 1 for encryption or Press 2 for decryption")
...
if dec == "1":
    ...
    charac = input("Enter the data you want to encrypt")
